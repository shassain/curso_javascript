var a = 1
let b = 2 //archivo, { }
const array = [1, 2, 3, 4, 5, 6]; //archivo, { }
//console.log("antes de cambiar", array)
array[0] = 7
...
//const => url, array, function
//console.log("Despues de cambiar", array)
//console.log("function", suma(2, 4))

let json_persona = {
  nombre: "juan",
  apellidos: "perez matinez",
  edad: 15,
  dinero: 129.2,
  mayor_edad: false,
  padre: {
...
for (hijo of json_persona.padre.hijos) {
  console.log("Nombre:", hijo.nombre)
  console.log("edad:", hijo.edad)
}
for (let i = 0; i < json_persona.habilidades.length; i++) {
  console.log("Habilidad " + (i + 1) + ":", json_persona.habilidades[i])
}
...
for (habilidad of poke.abilities) {
  /* let ability = habilidad.ability
  let is_hidden = habilidad.is_hidden
  let slot = habilidad.slot */
  //let { ability, is_hidden, slot } = habilidad
  let { ability } = habilidad
  let { url, name } = ability
  console.log(name, url)
}
//si es un  objeto
//si es un array
const array_ej = ["juan", "perez", 32];
let [nombre, apellido, edad] = array_ej
